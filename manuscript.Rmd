...
\autoref{alg:alg} and visualized in \autoref{fig:dpm-algorithm}. Overall, our 
formal model is highly flexible and can be used to bridge the gap between static
and dynamic models. Implementing the model in a Bayesian inferential framework 
using the Stan statistical programming language (*CITE*) further facilitates 
incorporation of ... me, regularizing, missing data .... While using 
computational efficient, cutting-edge MCMC algorithm...
...
\autoref{sec:social-complexity} summarizes two published examples of cultural
evolution in humans.
